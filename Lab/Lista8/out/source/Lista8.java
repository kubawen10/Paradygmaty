...
public void mousePressed(){
    Point p1 = new Point(PApplet.parseInt(random(5, 20)), PApplet.parseInt(random(5, 20)));
    Point p2 = new Point(PApplet.parseInt(random(5, 20)), PApplet.parseInt(random(100, 200)));
    Point p3 = new Point(PApplet.parseInt(random(100, 200)), PApplet.parseInt(random(5, 20)));
